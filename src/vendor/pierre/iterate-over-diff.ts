...
// https://github.com/pierrecomputer/pierre/blob/5ca34b1b809ac6f8bb13bb431e68dae1246522f4/packages/diffs/src/utils/iterateOverDiff.ts
// Modifications: adjusted imports and strict lint/type compatibility for
// suiseki's TypeScript layout.
...
function getChangeIterationRanges(
  ...
  const firstRange = iterationRanges[0]
  if (firstRange == null) {
    return []
  }

  const merged: [number, number][] = [firstRange]

...
export function generateAnnotatedConfig(): string {
  return [
    ...
    "",
    "# Render a file as plaintext (no syntax highlighting) when its diff has more",
    "# lines than this. Diff backgrounds and gutters are kept. Performance guard",
    "# for very large files; a dim note marks any file that falls back.",
    "# values: positive integer",
